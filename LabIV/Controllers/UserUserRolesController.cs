...
namespace LabIV.Controllers
{
    ...
    public class UserUserRolesController : ControllerBase
    {
        ...
        ///     }
        /// </remarks>
        /// <param name="userUserRolePostDTO">Input an userUserRole to be added</param>
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [HttpPost]

        public void Post([FromBody] UserUserRolePostDTO userUserRolePostDTO)
        {
            userUserRoleService.Create(userUserRolePostDTO);
        }
